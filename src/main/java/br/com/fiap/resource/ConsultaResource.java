 ...
 * </ul>
 *
 * ALUNO: Leonardo Zerbinatti de Sales, RM: 562992 TURMA: 1TDSPH
 * ALUNO: Lucas Tavares Dagrosa, RM: 563424 TURMA: 1TDSPG
 * ALUNO: Henrique Gonçalves Pacheco Costa, RM: 562086 TURMA: 1TDSPK
...
public class ConsultaResource {
    ...
    @Path("/{id_consulta}")
    @Produces(MediaType.APPLICATION_JSON)
    public Response findByCodigo(@PathParam("id_consulta") Long codigo) throws SQLException {
